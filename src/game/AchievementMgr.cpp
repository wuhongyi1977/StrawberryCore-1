...
void AchievementMgr::SendAchievementEarned(AchievementEntry const* achievement)
{
    ...
    {
        Strawberry::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_GUILD_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED,achievement->ID);
        Strawberry::LocalizedPacketDo<Strawberry::AchievementChatBuilder> say_do(say_builder);
    ...
    {
        Strawberry::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED,achievement->ID);
        Strawberry::LocalizedPacketDo<Strawberry::AchievementChatBuilder> say_do(say_builder);
        Strawberry::CameraDistWorker<Strawberry::LocalizedPacketDo<Strawberry::AchievementChatBuilder> > say_worker(GetPlayer(),sWorld.getConfig(CONFIG_FLOAT_LISTEN_RANGE_SAY),say_do);
...
void AchievementMgr::DoFailedTimedAchievementCriterias()
{
    ...
    for (AchievementCriteriaFailTimeMap::iterator iter = m_criteriaFailTimes.begin(); iter != m_criteriaFailTimes.end();)
    {
        ...
        if (!IsCompletedCriteria(criteria, achievement))
        {
            ...
            STRAWBERRY_ASSERT(pro_iter != m_criteriaProgress.end());
...
void AchievementGlobalMgr::LoadAchievementCriteriaList()
{
    ...
    for (uint32 entryId = 0; entryId < sAchievementCriteriaStore.GetNumRows(); ++entryId)
    {
        ...
        STRAWBERRY_ASSERT(criteria->requiredType < ACHIEVEMENT_CRITERIA_TYPE_TOTAL && "Not updated ACHIEVEMENT_CRITERIA_TYPE_TOTAL?");

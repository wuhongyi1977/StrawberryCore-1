...
#define MIN_STRAWBERRY_STRING_ID           1                    // 'strawberry_string'
#define MAX_STRAWBERRY_STRING_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_STRAWBERRY_STRING_ID // 'db_script_string'
...
class ObjectMgr
{
    ...
    public:
        ...
        bool LoadStrawberryStrings(DatabaseType& db, char const* table, int32 min_value, int32 max_value);
        bool LoadStrawberryStrings() { return LoadStrawberryStrings(WorldDatabase,"strawberry_string",MIN_STRAWBERRY_STRING_ID,MAX_STRAWBERRY_STRING_ID); }
        ...
        const char *GetStrawberryString(int32 entry, int locale_idx) const;

...
#ifndef STRAWBERRYSERVER_SPLINE_H
#define STRAWBERRYSERVER_SPLINE_H
...
protected:
    ...
    void UninitializedSpline() const { STRAWBERRY_ASSERT(false);}
...
public:
    ...
    template<class T> inline void initLengths(T& cacher)
    {
        ...
        while(i < index_hi)
        {
            ...
            STRAWBERRY_ASSERT(prev_length <= new_length);
...
#endif // STRAWBERRYSERVER_SPLINE_H

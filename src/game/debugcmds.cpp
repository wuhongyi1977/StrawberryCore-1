...
bool ChatHandler::HandleSetValueHelper(Object* target, uint32 field, char* typeStr, char* valStr)
{
    ...
    if(base)
    {
        ...
        DEBUG_LOG(GetStrawberryString(LANG_SET_UINT), guid.GetString().c_str(), field, iValue);
    ...
    else
    {
        ...
        DEBUG_LOG(GetStrawberryString(LANG_SET_FLOAT), guid.GetString().c_str(), field, fValue);
...
bool ChatHandler::HandleGetValueHelper(Object* target, uint32 field, char* typeStr)
{
    ...
    if (base)
    {
        ...
        switch(base)
        {
            case 2:
            {
                ...
                DEBUG_LOG(GetStrawberryString(LANG_GET_BITSTR), guid.GetString().c_str(), field, res.c_str());
                PSendSysMessage(LANG_GET_BITSTR_FIELD, guid.GetString().c_str(), field, res.c_str());
                break;
            }
            case 16:
                DEBUG_LOG(GetStrawberryString(LANG_GET_HEX), guid.GetString().c_str(), field, iValue);
                PSendSysMessage(LANG_GET_HEX_FIELD, guid.GetString().c_str(), field, iValue);
                break;
            case 10:
            default:
                DEBUG_LOG(GetStrawberryString(LANG_GET_UINT), guid.GetString().c_str(), field, iValue);
    ...
    else
    {
        ...
        DEBUG_LOG(GetStrawberryString(LANG_GET_FLOAT), guid.GetString().c_str(), field, fValue);
...
bool ChatHandler::HandlerDebugModValueHelper( Object* target, uint32 field, char* typeStr, char* valStr )
{
    ...
    if (type)
    {
        ...
        switch(type)
        {
            ...
            case 1:                                         // int +
                ...
                DEBUG_LOG(GetStrawberryString(LANG_CHANGE_INT32), guid.GetString().c_str(), field, iValue, value, value);
                PSendSysMessage(LANG_CHANGE_INT32_FIELD, guid.GetString().c_str(), field, iValue, value, value);
                break;
            case 2:                                         // |= bit or
                value |= iValue;
                DEBUG_LOG(GetStrawberryString(LANG_CHANGE_HEX), guid.GetString().c_str(), field, typeStr, iValue, value);
    ...
    else
    {
        ...
        DEBUG_LOG(GetStrawberryString(LANG_CHANGE_FLOAT), guid.GetString().c_str(), field, fValue, value);
...
bool ChatHandler::HandleDebugSpellCoefsCommand(char* args)
{
    ...
    char const* directHealStr = GetStrawberryString(LANG_DIRECT_HEAL);
    char const* directDamageStr = GetStrawberryString(LANG_DIRECT_DAMAGE);
    char const* dotHealStr = GetStrawberryString(LANG_DOT_HEAL);
    char const* dotDamageStr = GetStrawberryString(LANG_DOT_DAMAGE);

...
class ScriptMgr
{
    ...
    private:
        ...
        {
            ptr = (T)STRAWBERRY_GET_PROC_ADDR(m_hScriptLib, name);
        }
        ...
        STRAWBERRY_LIBRARY_HANDLE   m_hScriptLib;

        //atomic op counter for active scripts amount
        ACE_Atomic_Op<ACE_Thread_Mutex, long> m_scheduledScripts;

        void (STRAWBERRY_IMPORT* m_pOnInitScriptLibrary)();
        void (STRAWBERRY_IMPORT* m_pOnFreeScriptLibrary)();
        const char* (STRAWBERRY_IMPORT* m_pGetScriptLibraryVersion)();

        CreatureAI* (STRAWBERRY_IMPORT* m_pGetCreatureAI) (Creature*);
        InstanceData* (STRAWBERRY_IMPORT* m_pCreateInstanceData) (Map*);

        bool (STRAWBERRY_IMPORT* m_pOnGossipHello) (Player*, Creature*);
        bool (STRAWBERRY_IMPORT* m_pOnGOGossipHello) (Player*, GameObject*);
        bool (STRAWBERRY_IMPORT* m_pOnGossipSelect) (Player*, Creature*, uint32, uint32);
        bool (STRAWBERRY_IMPORT* m_pOnGOGossipSelect) (Player*, GameObject*, uint32, uint32);
        bool (STRAWBERRY_IMPORT* m_pOnGossipSelectWithCode) (Player*, Creature*, uint32, uint32, const char*);
        bool (STRAWBERRY_IMPORT* m_pOnGOGossipSelectWithCode) (Player*, GameObject*, uint32, uint32, const char*);
        bool (STRAWBERRY_IMPORT* m_pOnQuestAccept) (Player*, Creature*, Quest const*);
        bool (STRAWBERRY_IMPORT* m_pOnGOQuestAccept) (Player*, GameObject*, Quest const*);
        bool (STRAWBERRY_IMPORT* m_pOnItemQuestAccept) (Player*, Item*, Quest const*);
        bool (STRAWBERRY_IMPORT* m_pOnQuestRewarded) (Player*, Creature*, Quest const*);
        bool (STRAWBERRY_IMPORT* m_pOnGOQuestRewarded) (Player*, GameObject*, Quest const*);
        uint32 (STRAWBERRY_IMPORT* m_pGetNPCDialogStatus) (Player*, Creature*);
        uint32 (STRAWBERRY_IMPORT* m_pGetGODialogStatus) (Player*, GameObject*);
        bool (STRAWBERRY_IMPORT* m_pOnGOUse) (Player*, GameObject*);
        bool (STRAWBERRY_IMPORT* m_pOnItemUse) (Player*, Item*, SpellCastTargets const&);
        bool (STRAWBERRY_IMPORT* m_pOnAreaTrigger) (Player*, AreaTriggerEntry const*);
        bool (STRAWBERRY_IMPORT* m_pOnProcessEvent) (uint32, Object*, Object*, bool);
        bool (STRAWBERRY_IMPORT* m_pOnEffectDummyCreature) (Unit*, uint32, SpellEffectIndex, Creature*);
        bool (STRAWBERRY_IMPORT* m_pOnEffectDummyGO) (Unit*, uint32, SpellEffectIndex, GameObject*);
        bool (STRAWBERRY_IMPORT* m_pOnEffectDummyItem) (Unit*, uint32, SpellEffectIndex, Item*);
        bool (STRAWBERRY_IMPORT* m_pOnAuraDummy) (Aura const*, bool);
};

#define sScriptMgr Strawberry::Singleton<ScriptMgr>::Instance()

STRAWBERRY_DLL_SPEC uint32 GetAreaTriggerScriptId(uint32 triggerId);
STRAWBERRY_DLL_SPEC uint32 GetEventIdScriptId(uint32 eventId);
STRAWBERRY_DLL_SPEC uint32 GetScriptId(const char *name);
STRAWBERRY_DLL_SPEC char const* GetScriptName(uint32 id);
STRAWBERRY_DLL_SPEC uint32 GetScriptIdsCount();

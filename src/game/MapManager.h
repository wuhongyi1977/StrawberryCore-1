...
#ifndef STRAWBERRY_MAPMANAGER_H
#define STRAWBERRY_MAPMANAGER_H
...
class STRAWBERRY_DLL_DECL MapManager : public Strawberry::Singleton<MapManager, Strawberry::ClassLevelLockable<MapManager, ACE_Recursive_Thread_Mutex> >
{
    ...
    typedef Strawberry::ClassLevelLockable<MapManager, ACE_Recursive_Thread_Mutex>::Lock Guard;
    ...
    public:
        ...
        {
            return IsValidMAP(mapid) && Strawberry::IsValidMapCoord(x,y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x,float y,float z)
        {
            return IsValidMAP(mapid) && Strawberry::IsValidMapCoord(x,y,z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x,float y,float z,float o)
        {
            return IsValidMAP(mapid) && Strawberry::IsValidMapCoord(x,y,z,o);
        }

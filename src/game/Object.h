...
class STRAWBERRY_DLL_SPEC Object
{
    public:
        ...
        {
            STRAWBERRY_ASSERT( index < m_valuesCount || PrintIndexError( index , false) );
        ...
        {
            STRAWBERRY_ASSERT( index + 1 < m_valuesCount || PrintIndexError( index , false) );
...
class STRAWBERRY_DLL_SPEC WorldObject : public Object
{
    ...
    public:
        ...
        void SetMap(Map * map);
        Map * GetMap() const { STRAWBERRY_ASSERT(m_currMap); return m_currMap; }

...
void Spell::EffectDummy(SpellEffectEntry const* effect)
{
        ...
        case SPELLFAMILY_GENERIC:
        {
            switch(m_spellInfo->Id)
            {
                ...
                case 45583:                                 // Throw Gnomish Grenade
                {
                    ...
                    Strawberry::NearestGameObjectEntryInPosRangeCheck go_check_big(*unitTarget, 187675, unitTarget->GetPositionX(), unitTarget->GetPositionY(), unitTarget->GetPositionZ(), fMaxDist);
                    Strawberry::GameObjectSearcher<Strawberry::NearestGameObjectEntryInPosRangeCheck> checker1(pGo, go_check_big);
                    ...
                    Strawberry::GameObjectEntryInPosRangeCheck go_check_small(*unitTarget, 187676, unitTarget->GetPositionX(), unitTarget->GetPositionY(), unitTarget->GetPositionZ(), fMaxDist);
                    Strawberry::GameObjectListSearcher<Strawberry::GameObjectEntryInPosRangeCheck> checker2(lList, go_check_small);
                ...
                case 46171:                                 // Scuttle Wrecked Flying Machine
                {
                    ...
                    Strawberry::NearestGameObjectEntryInPosRangeCheck go_check(*unitTarget, 187675, unitTarget->GetPositionX(), unitTarget->GetPositionY(), unitTarget->GetPositionZ(), fMaxDist);
                    Strawberry::GameObjectSearcher<Strawberry::NearestGameObjectEntryInPosRangeCheck> checker(pGo, go_check);
                ...
                case 49634:                                 // Sergeant's Flare
                {
                    ...
                    // TODO: Strawberry::DynamicObjectUpdater::VisitHelper prevent aura to be applied to dummy creature (see HandleAuraDummy for effect of aura)
                ...
                case 51866:                                 // Kick Nass
                {
                    ...
                    Strawberry::NearestCreatureEntryWithLiveStateInObjectRangeCheck u_check(*m_caster, 28523, true, fRange*2);
                    Strawberry::CreatureLastSearcher<Strawberry::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(pTargetDummy, u_check);
                ...
                case 52371:                                 // Detonate Explosives
                {
                    ...
                    Strawberry::GameObjectEntryInPosRangeCheck go_check(*unitTarget, 182071, unitTarget->GetPositionX(), unitTarget->GetPositionY(), unitTarget->GetPositionZ(), fMaxDist);
                    Strawberry::GameObjectListSearcher<Strawberry::GameObjectEntryInPosRangeCheck> checker(lList, go_check);
    ...
    if (gameObjTarget)
        sScriptMgr.OnEffectDummy(m_caster, m_spellInfo->Id, SpellEffectIndex(effect->EffectIndex), gameObjTarget);
    else if (unitTarget && unitTarget->GetTypeId() == TYPEID_UNIT)
        sScriptMgr.OnEffectDummy(m_caster, m_spellInfo->Id, SpellEffectIndex(effect->EffectIndex), (Creature*)unitTarget);
    else if (itemTarget)
        sScriptMgr.OnEffectDummy(m_caster, m_spellInfo->Id, SpellEffectIndex(effect->EffectIndex), itemTarget);
}
...
void Spell::DoSummonVehicle(SpellEffectEntry const* effect, uint32 forceFaction)
{
    ...
    SpellEntry const* m_mountspell = sSpellStore.LookupEntry(effect->EffectBasePoints != 0 ? effect->CalculateSimpleValue() : 46598);
...
void Spell::EffectAddHonor(SpellEffectEntry const* /*effect*/)
{
    ...
    if (damage <= 50)
    {
        float honor_reward = Strawberry::Honor::hk_honor_at_level(unitTarget->getLevel(), damage);
        ...
        case SPELLFAMILY_GENERIC:
        {
            switch(m_spellInfo->Id)
            {
                ...
                case 44462:                                 // Cast Quest Complete on Master
                {
                    ...
                    Strawberry::NearestCreatureEntryWithLiveStateInObjectRangeCheck u_check(*m_caster, 24797, true, range);
                    Strawberry::CreatureLastSearcher<Strawberry::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(pQuestCow, u_check);

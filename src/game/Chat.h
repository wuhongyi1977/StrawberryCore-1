...
#ifndef STRAWBERRYSERVER_CHAT_H
#define STRAWBERRYSERVER_CHAT_H
...
class STRAWBERRY_DLL_SPEC ChatHandler
{
    public:
        ...
        virtual const char *GetStrawberryString(int32 entry) const;
    ...
    protected:
        ...
        bool HandleReloadStrawberryStringCommand(char* args);

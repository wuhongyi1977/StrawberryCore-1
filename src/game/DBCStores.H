...
#ifndef STRAWBERRY_DBCSTORES_H
#define STRAWBERRY_DBCSTORES_H
...
STRAWBERRY_DLL_SPEC AreaTableEntry const* GetAreaEntryByAreaID(uint32 area_id);
STRAWBERRY_DLL_SPEC AreaTableEntry const* GetAreaEntryByAreaFlagAndMap(uint32 area_flag,uint32 map_id);
...
STRAWBERRY_DLL_SPEC uint32 GetCreatureModelRace(uint32 model_id);
...
STRAWBERRY_DLL_SPEC DBCStorage <SoundEntriesEntry>          const* GetSoundEntriesStore();
STRAWBERRY_DLL_SPEC DBCStorage <SpellEntry>                 const* GetSpellStore();
STRAWBERRY_DLL_SPEC DBCStorage <SpellRangeEntry>            const* GetSpellRangeStore();
STRAWBERRY_DLL_SPEC DBCStorage <FactionEntry>               const* GetFactionStore();
STRAWBERRY_DLL_SPEC DBCStorage <ItemEntry>                  const* GetItemDisplayStore();
STRAWBERRY_DLL_SPEC DBCStorage <CreatureDisplayInfoEntry>   const* GetCreatureDisplayStore();
STRAWBERRY_DLL_SPEC DBCStorage <EmotesEntry>                const* GetEmotesStore();
STRAWBERRY_DLL_SPEC DBCStorage <EmotesTextEntry>            const* GetEmotesTextStore();
#endif

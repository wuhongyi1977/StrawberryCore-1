...
void Guild::CreateDefaultGuildRanks(int locale_idx)
{
    ...
    CreateRank(sObjectMgr.GetStrawberryString(LANG_GUILD_MASTER, locale_idx),   GR_RIGHT_ALL);
    CreateRank(sObjectMgr.GetStrawberryString(LANG_GUILD_OFFICER, locale_idx),  GR_RIGHT_ALL);
    CreateRank(sObjectMgr.GetStrawberryString(LANG_GUILD_VETERAN, locale_idx),  GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
    CreateRank(sObjectMgr.GetStrawberryString(LANG_GUILD_MEMBER, locale_idx),   GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
    CreateRank(sObjectMgr.GetStrawberryString(LANG_GUILD_INITIATE, locale_idx), GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
...
void Guild::LoadGuildEventLogFromDB()
{
    ...
    do
    {
        ...
        // events with same timestamp can appear when there is lag, and we naively suppose that strawberry isn't laggy

        ...
        case GO_READY:
        {
            ...
            if (isSpawned())
            {
                ...
                if (goInfo->type == GAMEOBJECT_TYPE_TRAP)
                {
                    ...
                    {
                        Strawberry::AnyUnfriendlyUnitInObjectRangeCheck u_check(this, owner, radius);
                        Strawberry::UnitSearcher<Strawberry::AnyUnfriendlyUnitInObjectRangeCheck> checker(ok, u_check);
                    ...
                    else                                    // environmental trap
                    {
                        ...
                        // affect only players
                        Player* p_ok = NULL;
                        Strawberry::AnyPlayerInObjectRangeCheck p_check(this, radius);
                        Strawberry::PlayerSearcher<Strawberry::AnyPlayerInObjectRangeCheck>  checker(p_ok, p_check);
                        Cell::VisitWorldObjects(this,checker, radius);
                        ok = p_ok;
                    }
...
void GameObject::TriggerLinkedGameObject(Unit* target)
{
...

    {
        ...
        Strawberry::NearestGameObjectEntryInObjectRangeCheck go_check(*this, trapEntry, range);
        Strawberry::GameObjectLastSearcher<Strawberry::NearestGameObjectEntryInObjectRangeCheck> checker(trapGO, go_check);
...
GameObject* GameObject::LookupFishingHoleAround(float range)
{
    ...
    Strawberry::NearestGameObjectFishingHoleCheck u_check(*this, range);
    Strawberry::GameObjectSearcher<Strawberry::NearestGameObjectFishingHoleCheck> checker(ok, u_check);
    Cell::VisitGridObjects(this,checker, range);

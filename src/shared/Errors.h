...
#ifndef STRAWBERRYSERVER_ERRORS_H
#define STRAWBERRYSERVER_ERRORS_H
...
#  define STRAWBERRY_ASSERT WPError
#else
#  define STRAWBERRY_ASSERT WPError                             // Error even if in release mode.
#endif

...
#ifndef STRAWBERRY_OBJECTREGISTRY_H
#define STRAWBERRY_OBJECTREGISTRY_H
...
class STRAWBERRY_DLL_DECL ObjectRegistry
{
    public:
    ...
    private:
        ...
        friend class Strawberry::OperatorNew<ObjectRegistry<T, Key> >;
